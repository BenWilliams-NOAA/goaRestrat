...
#'
#' @description
#' Function that computes original and re-stratified GOA survey indices (in biomass and numbers).
#'
...
get_index <- function(data = NULL,
  ...
  data$cpue %>%
    ...
    tidytable::mutate(subreg = tidytable::case_when(area_id == 803 ~ 'Central GOA',
